        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box" data-aos="fade-up">
              <img src="assets/images/eduLoan.jpg" style="max-height: 340px;" alt="">
              <div class="btn-wrap">
                <a href="EduForm.php" class="btn-buy">Education Loan</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box featured" data-aos="fade-up" data-aos-delay="100">
              <img src="assets/images/homeLoan.jpg" style="max-height: 340px;" alt="">
              <div class="btn-wrap">
                <a href="HomeForm.php" class="btn-buy">Home Loan</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="200">
              <img src="assets/images/carLoan.jpg" style="max-height: 340px;" alt="">
              <div class="btn-wrap">
                <a href="CarForm.php" class="btn-buy">Car Loan</a>
              </div>
            </div>
          </div>
