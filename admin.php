  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs mb-5">
      <div class="breadcrumb-hero">
        <div class="container">
          <div class="breadcrumb-hero">
            <h2>Welcome SBI <?php echo $_SESSION['fname'] ?> !</h2>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-md-center">
          ...
          <div class="col-lg-5 col-md-6">
            <div class="box" data-aos="fade-up">
                <img src="assets/images/ViewCustomers.jpg" style="max-height: 350px;" alt="">
              <div class="btn-wrap">
                <a href="viewCustomers.php" class="btn-buy">View Customers</a>
              </div>
            </div>
          </div>
          <div class="col-lg-5 col-md-6 mt-4 mt-md-0">
            <div class="box featured" data-aos="fade-up" data-aos-delay="100">
                <img src="assets/images/VerifyApplications.jpg" style="max-height: 350px;" alt="">
              <div class="btn-wrap">
                <a href="verifyApplications.php
                " class="btn-buy">Verify Applications</a>
              </div>
            </div>
          </div>
        </div>
